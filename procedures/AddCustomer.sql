...
**Description:** Adds a new customer to the database. The ID is auto-generated by the database. Returns the newly created ID as a single-row result set.
...
- `@CustomerDemographicsID`: Optional. Link to `CustomerDemographics` table.
