...
**Description:** Adds a new shipment/batch of a specific component to the inventory. This tracks the specific purchase price and date for a batch of items, allowing for FIFO/LIFO cost calculations later.
